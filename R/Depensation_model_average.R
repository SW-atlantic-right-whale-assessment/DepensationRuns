...
plot_suplus_prod(SIRlist = list(sir_base[[1]],
                 ...
                 file_name = "Model runs/Depensation_model_average/Depensation_model_average_set1")
...
plot_suplus_prod(SIRlist = list(sir_base[[1]],
                 ...
                 file_name = "Model runs/Depensation_model_average/Depensation_model_average_set2")
...
for(i in 2:length(sir_list)){
  ...
  plot_density_depensation(SIR = sir_list_tmp,  file_name = paste0("Model runs/",file_names[i]), col = c(1, "grey45",1), lwd = c(1,3,3), lty = c(1,1,1))
...
write.csv(table2, file = paste0(paste0("Model runs/",filename,"_bayes_factors_and_waic.csv")))
