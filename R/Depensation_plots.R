...
library(EnvStats)
source("R/Functions/plot_surplus_prod_function.R")
source("R/Functions/plot_density_depensation.R")
...
plot_suplus_prod(list(sir_depensation1[[1]], sir_depensation1[[2]], sir_base[[1]]), file_name = file_name, model_names = c("Dep-1", "Dep-1 prior", "Base"), coolors = c("#104F55", "#2F0A28", "#3185FC"))
...
plot_suplus_prod(list(sir_depensation2[[1]], sir_depensation2[[2]], sir_base[[1]]), file_name = file_name, model_names = c("Dep-2", "Dep-2 prior", "Base"), coolors = c("#104F55", "#2F0A28", "#3185FC"))
...
plot_suplus_prod(list(sir_depensation3[[1]], sir_depensation3[[2]], sir_base[[1]]), file_name = file_name, model_names = c("Dep-3", "Dep-3 prior", "Base"), coolors = c("#104F55", "#2F0A28", "#3185FC"))
...
plot_suplus_prod(list(sir_depensation4[[1]], sir_depensation4[[2]], sir_base[[1]]), file_name = file_name, model_names = c("Dep-4", "Dep-4 prior", "Base"), coolors = c("#104F55", "#2F0A28", "#3185FC"))
...
plot_suplus_prod(list(sir_depensation5[[1]], sir_depensation5[[2]], sir_base[[1]]), file_name = file_name, model_names = c("Dep-1b", "Dep-1b prior", "Base"), coolors = c("#104F55", "#2F0A28", "#3185FC"))
...
plot_suplus_prod(list(sir_depensation6[[1]], sir_depensation6[[2]], sir_base[[1]]), file_name = file_name, model_names = c("Dep-2b", "Dep-2b prior", "Base"), coolors = c("#104F55", "#2F0A28", "#3185FC"))
...
plot_suplus_prod(list(sir_depensation7[[1]], sir_depensation7[[2]], sir_base[[1]]), file_name = file_name, model_names = c("Dep-3b", "Dep-3b prior", "Base"), coolors = c("#104F55", "#2F0A28", "#3185FC"))
...
plot_suplus_prod(list(sir_depensation8[[1]], sir_depensation8[[2]], sir_base[[1]]), file_name = file_name, model_names = c("Dep-4", "Dep-4b prior", "Base"), coolors = c("#104F55", "#2F0A28", "#3185FC"))
